...
#     image_dir="data/uttar_pradesh/images",
#     prediction_dir="runs/obb/m0_obb_base_predict_uttar_pradesh/labels",
#     target_geojson_path="regions/labels/uttar_pradesh.geojson",
#     metadata_path="data/uttar_pradesh/metadata.geojson",
#     task="obb",
#     classes=["CFCBK", "FCBK", "Zigzag"],
#     save_dir="runs/obb/m0_obb_base_predict_uttar_pradesh",
#     conf_threshold=0.25,
# )
